...
public class MemberFileService {
    ...
    public MemberAttachedFile saveFile(MultipartFile mfile, String imageType) {
        ...
        return new MemberAttachedFile(originalFilename, savedFilename + ext, mfile.getSize(), imageType);
    }
